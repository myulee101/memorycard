...
questions_list.append(Question('Какой команды нет в Python?', 'home()', 'print()', 'input()', 'def()'))
questions_list.append(Question('Какой страны не существует?', 'Кандыркабан', 'Бутан', 'Бруней', 'Лихтенштейн'))
questions_list.append(Question('Какого слова нет в английском языке?', 'Pojlo', 'Presenteeism', 'Globish', 'Fatigue'))
questions_list.append(Question('Сколько стран в мире?', '195', '1487', '143', '423'))
questions_list.append(Question('Какая сила происходит, при погружении тела в жидкость?', 'Сила Архимеда', 'Сила трения', 'Сила притяжения', 'Сила тяжести'))
questions_list.append(Question('Сколько элементов в периодической таблице Менделеева?', '118', '127', '60', '93'))
questions_list.append(Question('Что происходит с водой при температуре 0 градусов?', 'Вода замерзает', 'Вода превращается в пар', 'Ничего', 'Вода становится снегом'))
questions_list.append(Question('Сколько людей живет в Казахстане?', '20 033 546+', '16 052 124+', '100 043 248', '32 952 125'))
questions_list.append(Question('Где проживают Пингвины?', 'Антарктика', 'Африка', 'Северная Америка', 'Евразия'))
questions_list.append(Question('Столица Казахстана', 'Астана (Нурсултан)', 'Алматы', 'Актобе', 'Петропавловск'))
questions_list.append(Question('2+2?', '4', '5', '6', '22'))
questions_list.append(Question('Число, у которого нет собственного числа?', '0', '1', '-1', 'Нету такого'))
...
def next_question():
    ...
    window.cur_question = randint(0, 5) # переходим к следующему вопросу
